...
class EngineConfig:
    ...
    the first fire; a caller can still override either explicitly.
    """
    ...
    def __post_init__(self) -> None:
        # Seed the inhibition-source M=1 defaults without clobbering any explicit
        # per-detector override the caller passed in ``detector_m``.
        for key, m in INHIBITION_SOURCE_M.items():
