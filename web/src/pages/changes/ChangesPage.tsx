 ...
 * a mono before/after diff. Revert is a Phase-4 write, so its control is present
 * but disabled with a plain note — no fake affordance. Read-only, keyboard-
 * traversable (j/k/arrows, Enter expands).
 */
  ...
  return (
    <div className="px-6 sm:px-8 py-8 max-w-[1100px] mx-auto">
      ...
      <p className="t-secondary mb-5" style={{ color: 'var(--fg-muted)' }}>
        ...
        before/after. Revert lands in Phase 4.
      </p>
                    ...
                    <div className="px-4 pb-4 pt-1" style={{ background: 'var(--canvas)' }}>
                      ...
                      <div className="flex items-center gap-3 mt-3">
                        <Button
                          ...
                          size="sm"
                          disabled
                          title="Revert is available in Phase 4"
                        >
                          Revert
                        </Button>
                        <span className="t-caption" style={{ color: 'var(--fg-subtle)' }}>
                          {c.status === 'reverted' && c.reverted_ts
                            ...
                            : 'Revert lands in Phase 4 — this ledger is read-only for now.'}
                        </span>
                      </div>
                    </div>
                  )}
