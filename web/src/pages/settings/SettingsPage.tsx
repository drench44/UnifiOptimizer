 ...
 * not yet a /api/system/config, so controller host, detector thresholds, and the
 * HA/LLM integrations are shown as honest "not exposed yet / Phase 4" sections
 * rather than invented. When a config endpoint ships, wire it here (see
 * INTEGRATION note) — the redactHost helper is already in place for host-only display.
 */
      ...
      {loading && !health ? (
        ...
        <>
          ...
          <Section title="Home Assistant">
            <PhasePlaceholder note="Home Assistant integration is configured in Phase 4." />
          </Section>

          <Section title="LLM provider">
            <PhasePlaceholder note="The investigator's LLM provider is configured in Phase 4." />
          </Section>
        </>
      ) : null}
    </div>
