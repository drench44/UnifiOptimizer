...
from netadmin.ingest.unifi.models import Alarm, Anomaly, Device, HealthSubsystem, RogueAp
...
class FakeEndpoints:
    ...
    def __init__(
        self, *, devices=None, clients=None, health=None, rogues=None, alarms=None, anomalies=None
    ):
