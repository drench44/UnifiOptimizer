...
# The full catalog-v1 registration (docs/ARCHITECTURE.md sections 6 & 17): 2 infra
# + 8 wired + 3 client + 5 wan + 2 net + 12 wifi. All detectors land here as their
...
# detector, the honest substitute for gateway-less bufferbloat); the 12th wifi
# detector is wifi.rogue_ap (the §17 correlation-layer neighbor-BSS surfacer).
CATALOG_V1_SIZE = 32
